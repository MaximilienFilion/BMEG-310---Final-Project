...
# Define the columns 
cols <- c("SEX", "RACE", "ETHNICITY", "GENETIC_ANCESTRY_LABEL")

# Plot pie chart for every variable
for (col in cols) {
  # Create frequency table, converting blanks to Unknown
  freq <- table(ifelse(data_clinical_patient[[col]] == "" | 
                       is.na(data_clinical_patient[[col]]), 
                       "Unknown", 
...
#Need to finish when I see the actual changes
```
