...
data_clinical_patient <- data_clinical_patient %>%
  mutate(
    ...
    AJCC_clean = toupper(str_replace_all(AJCC_PATHOLOGIC_TUMOR_STAGE, " ", "")),
    AJCC_PATHOLOGIC_TUMOR_STAGE = str_replace_all(AJCC_clean, c(
       "STAGEIV" = "4", 
       "STAGEIII" = "3",
       "STAGEII" = "2",
       "STAGEI" = "1")
    ...
    AJCC_PATHOLOGIC_TUMOR_STAGE = as.numeric(AJCC_PATHOLOGIC_TUMOR_STAGE)
  )
head(data_clinical_patient)
```
